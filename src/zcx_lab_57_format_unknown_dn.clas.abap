CLASS zcx_lab_57_format_unknown_dn DEFINITION INHERITING FROM cx_static_check
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zcx_lab_57_format_unknown_dn IMPLEMENTATION.
