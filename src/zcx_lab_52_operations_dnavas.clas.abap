CLASS zcx_lab_52_operations_dnavas DEFINITION INHERITING FROM cx_static_check
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zcx_lab_52_operations_dnavas IMPLEMENTATION.
